// =========================================================================
// Ruleta Semanal — modelo de premios y disponibilidad (lógica pura)
// -------------------------------------------------------------------------
// Este módulo NO toca Firestore: son funciones puras que deciden qué premio
// puede salir hoy y qué forma tiene un premio. Vive aquí (y espejado en
// src/utils/ruletaModel.js) porque el sorteo lo hace el servidor pero la rueda
// la pinta el cliente: si los dos no filtran EXACTAMENTE igual, la rueda para
// en un gajo que no corresponde al premio que ganó el usuario.
//
// Mismo pacto que fechaLima.js <-> economyLogic.js: si cambias algo aquí,
// cambia el espejo.
// =========================================================================
...
const VIGENCIA_CUPON_POR_DEFECTO = 30; // días
...
function premioDisponible(premio, ctx) {
...
function premiosDeHoy(premiosCrudos, ctx) {
...
const MODOS_DESBLOQUEO = ["racha7", "siempre"];
...
function sortearPremio(premios, aleatorio) {
...
function sumaProbabilidades(premios) {
...
function anguloDeParada(indice, total, vueltas) {
