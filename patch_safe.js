...
// Put line endings back to original \r\n if needed, though \n works fine in modern IDEs
fs.writeFileSync(file, content);
console.log('Patch applied safely with replace() after normalizing newlines.');
