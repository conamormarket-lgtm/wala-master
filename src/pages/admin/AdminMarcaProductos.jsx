...
import { ArrowLeft, PlusCircle, Search, Loader2, PackagePlus, PackageMinus, X, CheckCircle2 } from 'lucide-react';
  ...
  return (
    <div className={styles.panel}>
      ...
      <div className={styles.headerBlock}>
        <h2 className={styles.brandHeading}>Productos de {brand.name}</h2>
        <p className={styles.brandSub}>
          Asigna o quita productos de esta marca. Solo se cambia la marca del producto;
          el precio, el stock y la forma de cobro no se tocan.
        </p>
      </div>
