  ...
  return (
    <div className={styles.wrapper}>
      ...
      <div className={styles.ctaContainer}>
        ...
        <h1><T>Mis Pedidos</T></h1>
        <p><T>Inicia sesión con tu cuenta para ver y rastrear tus pedidos.</T></p>
        <Link to="/login">
        ...
        <p className={styles.registro}>
          ¿No tienes cuenta? <Link to="/registro" className={styles.link}><T>Regístrate aquí</T></Link>
        </p>
      </div>
    </div>
  );
