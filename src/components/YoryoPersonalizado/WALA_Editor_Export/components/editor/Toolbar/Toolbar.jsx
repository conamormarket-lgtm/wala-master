...
const Toolbar = () => {
  ...
  return (
    <div className={styles.toolbar}>
      {/* ─────────────────────────────────────────────
          VERSIÓN DESKTOP (sidebar clásico)
          ───────────────────────────────────────────── */}
      ...
      {createPortal(
        <div className={styles.mobileOnly}>
          ...
          <div className={styles.mobileTabBar}>
            <button onClick={() => toggleMobileTab('add')} className={mobileTab === 'add' && isMobilePanelOpen ? styles.mobileTabActive : styles.mobileTab}>
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M12 4v16m8-8H4" /></svg>
              Añadir
            </button>
            <button onClick={() => toggleMobileTab('edit')} className={mobileTab === 'edit' && isMobilePanelOpen ? styles.mobileTabActive : styles.mobileTab}>
            ...
            <button onClick={() => toggleMobileTab('layers')} className={mobileTab === 'layers' && isMobilePanelOpen ? styles.mobileTabActive : styles.mobileTab}>
