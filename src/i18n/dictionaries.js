...
export const dictionaries = {
  ...
  es: {
    ...
    'nav.marcas': 'Marcas',
    'account.misPedidos': 'Mis Pedidos',
    'account.rastreo': 'Rastreo del Pedido',
    'card.comprar': 'Comprar',
    'card.comprarCarrito': 'Comprar todo el carrito',
    'cat.todos': 'Todos',
    'cat.precio': 'Precio',
    'cat.desde': 'Desde',
    'cat.hasta': 'Hasta',
    'cat.limpiar': 'Limpiar',
    'cat.precioMinimo': 'Precio mínimo',
    'cat.precioMaximo': 'Precio máximo',
    'cat.quitarPrecio': 'Quitar rango',
    'grid.cargarMas': 'Cargar más',
    'grid.finLista': 'Has visto todos los productos',
  ...
  en: {
    ...
    'nav.marcas': 'Brands',
    'account.misPedidos': 'My Orders',
    'account.rastreo': 'Order Tracking',
    'card.comprar': 'Buy',
    'card.comprarCarrito': 'Buy the whole cart',
    'cat.todos': 'All',
    'cat.precio': 'Price',
    'cat.desde': 'From',
    'cat.hasta': 'To',
    'cat.limpiar': 'Clear',
    'cat.precioMinimo': 'Minimum price',
    'cat.precioMaximo': 'Maximum price',
    'cat.quitarPrecio': 'Remove range',
    'grid.cargarMas': 'Load more',
    'grid.finLista': 'You have seen every product',
  ...
  pt: {
    ...
    'nav.marcas': 'Marcas',
    'account.misPedidos': 'Meus Pedidos',
    'account.rastreo': 'Rastreamento do Pedido',
    'card.comprar': 'Comprar',
    'card.comprarCarrito': 'Comprar todo o carrinho',
    'cat.todos': 'Todos',
    'cat.precio': 'Preço',
    'cat.desde': 'De',
    'cat.hasta': 'Até',
    'cat.limpiar': 'Limpar',
    'cat.precioMinimo': 'Preço mínimo',
    'cat.precioMaximo': 'Preço máximo',
    'cat.quitarPrecio': 'Remover intervalo',
    'grid.cargarMas': 'Carregar mais',
    'grid.finLista': 'Você viu todos os produtos',
