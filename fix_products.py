...
# find where normalizeProductPayload starts
start_idx = -1
for i, line in enumerate(lines):
    if line.startswith('function normalizeProductPayload'):
        start_idx = i
        break

def normalizeProductPayloadStr():
    return '''function normalizeProductPayload(data) {
...
with open('src/services/products.js', 'w', encoding='utf-8') as f:
    ...
    f.write(normalizeProductPayloadStr())

print('Done rewriting bottom of file!')
